...
if [ -f ".env.security" ]; then
    ...
    # Host Ports
    read -p "  LLM Proxy Host Port [10001]: " SECURITY_LLM_PROXY_PORT
    SECURITY_LLM_PROXY_PORT="${SECURITY_LLM_PROXY_PORT:-10001}"
    read -p "  API Proxy Host Port [10000]: " SECURITY_API_PROXY_PORT
    SECURITY_API_PROXY_PORT="${SECURITY_API_PROXY_PORT:-10000}"
